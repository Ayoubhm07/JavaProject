...
private static final String[] FORBIDDEN_WORDS = {"fuck", "shutup", "damn"};
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        responses.put("who are you ?", "je suis un chatbot créer par Hammoudi Ayoub ");
    ...
    private void UserA(ActionEvent event) throws Exception {
        ...
        if (input.contains(forbiddenWord)) {
            ...
            if (alertCount == MAX_ALERTS) {
                ...
                alert.showAndWait();
                   Mail m = new Mail();
                m.sendMail("ayoub.hammoudi@esprit.tn", "Vous Avez été banni à cause de l'use des gros mots ! merci de respecter le reglement de l'application la prochaine fois .");
                Platform.exit();
            } else {
    ...
    private void OnHomeClicked(ActionEvent event) throws IOException {
        ...
        BackHomeController s = new BackHomeController();
