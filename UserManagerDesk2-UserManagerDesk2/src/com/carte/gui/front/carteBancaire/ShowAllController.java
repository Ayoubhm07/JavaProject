...
public class ShowAllController implements Initializable {
    ...
    public Parent makeCarteBancaireModel(
        ...
        Parent parent = null;
        try {
            parent = FXMLLoader.load(Objects.requireNonNull(getClass().getResource(Constants.FXML_FRONT_MODEL_CARTEBANCAIRE)));
    ...
    private void ajouterCarteBancaire(ActionEvent event) {
        ...
        MainWindowController.getInstance().loadInterface(Constants.FXML_FRONT_MANAGE_CARTEBANCAIRE);
    }
