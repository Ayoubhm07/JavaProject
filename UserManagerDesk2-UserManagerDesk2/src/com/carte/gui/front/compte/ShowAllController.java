...
public class ShowAllController implements Initializable {
    ...
    public Parent makeCompteModel(
        ...
        Parent parent = null;
        try {
            parent = FXMLLoader.load(Objects.requireNonNull(getClass().getResource(Constants.FXML_FRONT_MODEL_COMPTE)));
    ...
    private void ajouterCompte(ActionEvent event) {
        currentCompte = null;
        MainWindowController.getInstance().loadInterface(Constants.FXML_FRONT_MANAGE_COMPTE);
    }
